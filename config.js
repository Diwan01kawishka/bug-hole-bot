...
module.exports = {
    VERSION: 'bug-hole-bot',
    CHANNEL: 'https://wa.me//94777188481',
    SESSION: process.env.BUG_SESSION === undefined ? '' : process.env.BUG_SESSION,
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈  ²⁰²²' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈  ²⁰²²' : process.env.CAPTION,
    ...
    DEPLOYER: process.env.DEPLOYER === undefined ? 'Bug Hole USER' : process.env.DEPLOYER,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'Bug-Hole-BOt' : process.env.BOT_NAME,
